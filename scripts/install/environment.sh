...
# crm-apiserver 配置
readonly CRM_APISERVER_INSECURE_BIND_ADDRESS=${CRM_APISERVER_INSECURE_BIND_ADDRESS:-127.0.0.1}
readonly CRM_APISERVER_INSECURE_BIND_PORT=${CRM_APISERVER_INSECURE_BIND_PORT:-48866}